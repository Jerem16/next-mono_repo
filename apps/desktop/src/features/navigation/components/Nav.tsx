...
import { MenuItem } from "@nav-data/menuItems";
import { useMenuBehavior } from "@nav-utils/updateMenuUtils";
import NavLinkShow from "@nav-components/navLink/NavLinkShow";
import NavInput from "@nav-components/navInput/NavInput";
...
const Nav: React.FC<NavProps> = ({
  ...
  const renderMenu = (menuItems: MenuItem[] | undefined) =>
    ...
    return (
        <div ref={navRef as React.RefObject<HTMLDivElement>} className="head-flex">
      <nav
        className={`main-nav`}
