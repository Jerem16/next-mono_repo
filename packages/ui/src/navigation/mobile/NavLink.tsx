...
import { useNavigation, makeClickHandler } from "../core";
import { svgComponents } from "./icons";

const isSvgIconName = (
    value: string
): value is keyof typeof svgComponents => value in svgComponents;
...
const NavLink: React.FC<NavLinkProps> = ({
    ...
    const SvgIcon = useMemo(() => {
        if (!menuItem.svg || !isSvgIconName(menuItem.svg)) {
            return undefined;
        }
        return svgComponents[menuItem.svg];
    }, [menuItem.svg]);
